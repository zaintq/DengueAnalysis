...
<html>
  ...
  <body>
    ...
    for ($i = 0; $i < $total_clusters; $i++) {
	  ...
	  echo 'console.log("coords_file:"+"'.$coords_filename.'");';
	  echo 'console.log("hull_file:"+"'.$hull_filename.'");';
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?signed_in=true&callback=initMap&key=AIzaSyAq2lxSeMQ_zPr-52sYgG-MwUlvKBYmMeU">
    </script>
